...
<br />
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">User Module</h3>
                </div>
...
<?php 
	...
	?>		
			<div class="col-xs-3">
				...
				<p class="page-header">
				<span>
				<a class="btn btn-primary" href="deletejob.php?delete_id=<?php echo $row['appID']; ?>" title="click for delete" onclick="return confirm('sure to revoke ?')"> Revoke</a>
				</span>
				</p>
			</div>       
<?php			
